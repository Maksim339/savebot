...
class InstaloaderContext:
    ...
    def login(self, user, passwd):
        ...
        # proxies = {
        #     'http': 'http://access_group_ge:85cfc26f64@78.142.236.85:30001',
        #     'https': 'https://access_group_ge:85cfc26f64@78.142.236.85:30001'
        # }

        # def get_proxy():
        #     proxy = ['45.136.173.160:7750',
        #              '193.23.245.11:8582',
        #              '193.23.245.235:8806']
        #     random_proxy = random.choice(proxy)
        #     return random_proxy

        proxy = '193.23.253.222:7794'
        proxies = {
            'http': 'http://' + proxy,
            'https': 'https://' + proxy,
        }
